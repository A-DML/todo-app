  ...
  <div id="app" class="flex container h-screen w-full">
    ...
    <div class="lg:w-1/5 border-r border-lighter px-2 lg:px-6 py-2 flex flex-col justify-between">
      <div>
        ...
        <div>
          <button v-for="(tab, i) in tabs" :key="i" @click="id = tab.id" :class="`focus:outline-none hover:text-blue flex items-center py-2 px-4 hover:bg-lightblue rounded-full mr-auto mb-3 ${ id === tab.id ? 'text-blue' : ''}`">
    ...
    <div class="w-full md:w-1/2 h-full overflow-y-scroll">
      ...
      <div class="flex flex-col-reverse">
        <div v-bind="tweet in tweets" class="w-full p-4 border-b hover:bg-lighter flex">
      ...
      <div v-for="(follow, i) in following" :key="i" class="w-full p-4 border-b hover:bg-lighter flex">
        <div class="flex-none mr-4">
    ...
    <div class="md:block hidden w-1/3 h-full border-l border-lighter py-2 px-6 overflow-y-scroll relative">
      ...
      <div class="w-full rounded-lg bg-lightest">
        ...
        <button v-for="(trend, i) in trending" :key="i" class="w-full flex justify-between hover:bg-lighter p-3 bordser-t border-lighter">
          <div>
      ...
      <div class="w-full rounded-lg bg-lightest my-4">
        ...
        <button v-for="(friend, i) in friends" :key="i" class="w-full flex hover:bg-lighter p-3 border-t border-lighter">
